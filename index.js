...
function goFurther(){
  if (document.getElementById("chkAgree").checked == true) {
    document.getElementById('btnSubmit').style = 'background: linear-gradient(to right, );';
  }
  else{
...
function display(n) {
  ...
  s1.style = 'background: #44A748; color: #FFF;';
  s2.style = 'background: #44A748; color: #FFF;';
  s3.style = 'background: #44A748; color: #FFF;';
  s4.style = 'background: #44A748; color: #FFF;';

  if(n==1) {
    img1.style = 'display: block;';
    s1.style = 'background: #44A748; color: #DF2771;';
  }
  if(n==2) {
    img2.style = 'display: block;';
    s2.style = 'background: #44A748; color: #DF2771;';
  }
  if(n==3) {
    img3.style = 'display: block;';
    s3.style = 'background: #44A748; color: #DF2771;';
  }
  if(n==4) {
    img4.style = 'display: block;';
    s4.style = 'background: #44A748; color: #DF2771;';
  } 
}
